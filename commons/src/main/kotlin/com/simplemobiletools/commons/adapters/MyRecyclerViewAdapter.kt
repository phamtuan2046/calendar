...
import kotlinx.android.synthetic.main.item_ads_facebook_even.view.*
import java.util.*
...
abstract class MyRecyclerViewAdapter(val activity: BaseSimpleActivity, val recyclerView: MyRecyclerView, val itemClick: (Any) -> Unit)
    ...
    class ViewHolder(var view: View, val adapterListener: MyAdapterListener, val activity: BaseSimpleActivity, val multiSelectorCallback: ModalMultiSelectorCallback,
        ...
        fun innitAdsFace(AdsFaceNative: NativeAd, context: Context) {
            view.nativeAdTitle.text = AdsFaceNative.adTitle
//            itemView.nativeAdSocialContext.text = AdsFaceNative.adSocialContext
//            itemView.nativeAdBody.text = AdsFaceNative.adBody
            view.nativeAdCallToAction.text = AdsFaceNative.adCallToAction

            // Download and display the ad icon.
            val adIcon = AdsFaceNative.adIcon
            NativeAd.downloadAndDisplayImage(adIcon, view.nativeAdIcon)

            // Download and display the cover image.
            view.nativeAdMedia.setNativeAd(AdsFaceNative)


//            val adChoicesView = AdChoicesView(context, AdsFaceNative, true)
//            view.adChoicesContainer.addView(adChoicesView)

            // Register the Title and CTA button to listen for clicks.
            val clickableViews = ArrayList<View>()
            clickableViews.add(view.nativeAdTitle)
            clickableViews.add(view.nativeAdCallToAction)
            AdsFaceNative.registerViewForInteraction(view.nativeAdContainer, clickableViews)
        }
    }
