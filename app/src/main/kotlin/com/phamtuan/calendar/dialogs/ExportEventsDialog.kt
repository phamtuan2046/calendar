...
class ExportEventsDialog(val activity: com.phamtuan.calendar.activities.SimpleActivity, val path: String, val callback: (exportPastEvents: Boolean, file: File, eventTypes: HashSet<String>) -> Unit) {
        ...
        val view = (activity.layoutInflater.inflate(R.layout.dialog_export_events, null) as ViewGroup).apply {
            ...
            activity.dbHelper.getEventTypes {
                ...
                activity.runOnUiThread {
                    export_events_types_list.adapter = com.phamtuan.calendar.adapters.FilterEventTypeAdapter(activity, it, eventTypes)
                    if (it.size > 1) {
                ...
                getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener {
                    ...
                    when {
                        ...
                        filename.isAValidFilename() -> {
                            ...
                            val eventTypes = (view.export_events_types_list.adapter as com.phamtuan.calendar.adapters.FilterEventTypeAdapter).getSelectedItemsSet()
