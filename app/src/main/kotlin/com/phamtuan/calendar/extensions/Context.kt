...
import com.phamtuan.calendar.receivers.CalDAVSyncReceiver
import com.phamtuan.calendar.receivers.NotificationReceiver
import com.phamtuan.calendar.services.SnoozeService
...
private fun getPendingIntent(context: Context, event: Event): PendingIntent {
    val intent = Intent(context, com.phamtuan.calendar.activities.EventActivity::class.java)
    intent.putExtra(EVENT_ID, event.id)
    intent.putExtra(EVENT_OCCURRENCE_TS, event.startTS)
