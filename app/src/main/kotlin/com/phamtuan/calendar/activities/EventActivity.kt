...
import com.phamtuan.calendar.dialogs.*
...
import com.phamtuan.calendar.models.CalDAVCalendar
...
class EventActivity : com.phamtuan.calendar.activities.SimpleActivity() {
    ...
    private fun showRepetitionTypePicker() {
        hideKeyboard()
        com.phamtuan.calendar.dialogs.RepeatLimitTypePickerDialog(this, mRepeatLimit, mEventStartDateTime.seconds()) {
            setRepeatLimit(it)
        }
    }
    ...
    private fun showRepetitionRuleDialog() {
        hideKeyboard()
        if (mRepeatInterval.isXWeeklyRepetition()) {
            com.phamtuan.calendar.dialogs.RepeatRuleWeeklyDialog(this, mRepeatRule) {
                setRepeatRule(it)
            }
        } else if (mRepeatInterval.isXMonthlyRepetition()) {
    ...
    private fun showEventTypeDialog() {
        hideKeyboard()
        com.phamtuan.calendar.dialogs.SelectEventTypeDialog(this, mEventTypeId) {
            mEventTypeId = it
            updateEventType()
        }
    }
    ...
    private fun updateCalDAVCalendar() {
        if (config.caldavSync) {
            ...
            event_caldav_calendar_holder.setOnClickListener {
                hideKeyboard()
                com.phamtuan.calendar.dialogs.SelectEventCalendarDialog(this, calendars, mEventCalendarId) {
    ...
    private fun deleteEvent() {
        com.phamtuan.calendar.dialogs.DeleteEventDialog(this, arrayListOf(mEvent.id)) {
            if (it) {
    ...
    private fun storeEvent(wasRepeatable: Boolean) {
        if (mEvent.id == 0) {
            ...
            if (mRepeatInterval > 0 && wasRepeatable) {
                com.phamtuan.calendar.dialogs.EditRepeatingEventDialog(this) {
                    if (it) {
