...
import com.phamtuan.calendar.extensions.scheduleCalDAVSync
...
class CalDAVHandler(val context: Context) {
    ...
    private fun fetchCalDAVCalendarEvents(calendarId: Int, eventTypeId: Int, activity: com.phamtuan.calendar.activities.SimpleActivity?) {
