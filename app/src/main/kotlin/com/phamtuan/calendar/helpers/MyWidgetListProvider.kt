...
import com.phamtuan.calendar.extensions.launchNewEventIntent
import com.phamtuan.calendar.services.WidgetService
...
class MyWidgetListProvider : AppWidgetProvider() {
    ...
    private fun performUpdate(context: Context) {
        ...
        appWidgetManager.getAppWidgetIds(getComponentName(context)).forEach {
            ...
            val startActivityIntent = Intent(context, com.phamtuan.calendar.activities.SplashActivity::class.java)
    ...
    private fun launchDayActivity(context: Context) {
        Intent(context, com.phamtuan.calendar.activities.DayActivity::class.java).apply {
